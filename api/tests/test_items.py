...
# Test UNAUTHORIZED
    ...
    def test_get_single_unauthorized(self):
        self.client.headers["API_KEY"]="wrong_key"
        response = self.client.get("/items/P000008")
    ...
    def test_delete_incorrect_id_unauthorized(self):
        self.client.headers["API_KEY"]="wrong_key"
        response = self.client.delete("/items/AP200001")

        self.assertEqual(response.status_code, codes.UNAUTHORIZED)
    
    def test_update_item2_unauthorized(self):
        self.client.headers["API_KEY"]="wrong_key"
        updated_client = {
            "uid": "P000099",
            "code": "saB23409A",
            "description": "Osmanoglu",
        ...
        response = self.client.put("/items/P000045", json=updated_client)
    ...
    def test_get_incorrect_id(self):
        response = self.client.get("/items/AP000099")
    ...
    def test_get_single2(self):
        response = self.client.get("/items/P000019")
